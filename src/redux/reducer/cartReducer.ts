...
export const cartReducer = createSlice({
    name: "cartReducer", initialState, reducers: {
        ...
        discoundApplied: (state, action: PayloadAction<number>) => {
...
export const { addToCart, removeCartItem, calculatePrice, discoundApplied, saveShippingInfo, resetCart } = cartReducer.actions